...
//    (the bulid process should yield a DelayE.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:DelayE.chug DelayE-test.ck`
//
...
//    `chuck --chugin:DelayE.chug DelayE-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a DelayE
DelayE obj;
