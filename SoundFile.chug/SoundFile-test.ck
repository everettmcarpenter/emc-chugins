...
//    (the bulid process should yield a SoundFile.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:SoundFile.chug SoundFile-test.ck`
//
...
//    `chuck --chugin:SoundFile.chug SoundFile-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a SoundFile
SoundFile obj;
