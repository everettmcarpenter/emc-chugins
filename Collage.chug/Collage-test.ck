...
//    (the bulid process should yield a Collage.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:Collage.chug Collage-test.ck`
//
...
//    `chuck --chugin:Collage.chug Collage-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a Collage
Collage obj;
