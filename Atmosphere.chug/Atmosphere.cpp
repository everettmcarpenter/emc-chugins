...
CK_DLL_CTOR( atmosphere1_3ctor );
CK_DLL_CTOR( atmosphere1_4ctor );
...
CK_DLL_MFUN( atmosphere1_getTargetPitch );
...
CK_DLL_MFUN( atmosphere1_getTargetPosition );
CK_DLL_MFUN( atmosphere1_setRandomPosition );
CK_DLL_MFUN( atmosphere1_getRandomPosition );

CK_DLL_MFUN( atmosphere1_openFile );
CK_DLL_MFUN( atmosphere1_closeFile );
CK_DLL_MFUN( atmosphere1_duration );
CK_DLL_MFUN( atmosphere1_sync );
...
CK_DLL_CTOR( atmosphere2_3ctor );
CK_DLL_CTOR( atmosphere2_4ctor );
...
CK_DLL_MFUN( atmosphere2_getTargetPitch );
...
CK_DLL_MFUN( atmosphere2_getTargetPosition );
CK_DLL_MFUN( atmosphere2_setRandomPosition );
CK_DLL_MFUN( atmosphere2_getRandomPosition );

CK_DLL_MFUN( atmosphere2_openFile );
CK_DLL_MFUN( atmosphere2_closeFile );
CK_DLL_MFUN( atmosphere2_duration );
CK_DLL_MFUN( atmosphere2_sync );
...
CK_DLL_QUERY( Atmosphere )
{
    ...
    // register default constructor
    QUERY->add_ctor( QUERY, atmosphere1_3ctor );
    QUERY->add_arg( QUERY, "string", "file" );

    // register default constructor
    QUERY->add_ctor( QUERY, atmosphere1_4ctor );
	QUERY->add_arg( QUERY, "int", "grains" );
	...
	// example of adding getter method
    QUERY->add_mfun( QUERY, atmosphere1_getTargetPitch, "float", "targetPitch" );
    ...
    // example of adding getter method
    QUERY->add_mfun( QUERY, atmosphere1_getTargetPosition, "float", "targetPosition" );

	QUERY->add_mfun( QUERY, atmosphere1_openFile, "void", "openFile" );
	QUERY->add_arg( QUERY, "string", "filepath" );
	
	QUERY->add_mfun( QUERY, atmosphere1_closeFile, "void", "closeFile" );
	
	QUERY->add_mfun( QUERY, atmosphere1_duration, "dur", "duration" );

	QUERY->add_mfun( QUERY, atmosphere1_sync, "void", "sync" );
    ...
    // register default constructor
    QUERY->add_ctor( QUERY, atmosphere2_3ctor );
    QUERY->add_arg( QUERY, "string", "file" );

	// register default constructor
    QUERY->add_ctor( QUERY, atmosphere2_4ctor );
	QUERY->add_arg( QUERY, "int" , "grains" );
    ...
    // example of adding getter method
    QUERY->add_mfun( QUERY, atmosphere2_getTargetPitch, "float", "targetPitch" );
    ...
    // example of adding getter method
    QUERY->add_mfun( QUERY, atmosphere2_getTargetPosition, "float", "targetPosition" );
	...
	QUERY->add_mfun( QUERY, atmosphere2_openFile, "void", "openFile" );
	QUERY->add_arg( QUERY, "string", "filepath" );
	
	QUERY->add_mfun( QUERY, atmosphere2_closeFile, "void", "closeFile" );
	
	QUERY->add_mfun( QUERY, atmosphere2_duration, "dur", "duration" );

	QUERY->add_mfun( QUERY, atmosphere2_sync, "void", "sync" );
...
CK_DLL_CTOR( atmosphere1_2ctor )
{
    ...
    {
		API->vm->throw_exception("Atmosphere", "Provided file does not contain the adequate number of channels, Atmosphere1 requires 4 channels.", nullptr);
		return;
    }
...
CK_DLL_MFUN( atmosphere1_getTargetPitch )
{
    ...
    // call getParam() and set the return value
    RETURN->v_float = a_obj->getTargetPitch();
}
...
CK_DLL_MFUN( atmosphere1_getTargetPosition )
{
    ...
    // call getParam() and set the return value
    RETURN->v_float = a_obj->getTargetPosition();
}
...
CK_DLL_CTOR( atmosphere2_2ctor )
{
    ...
    if( !a_obj->openFile( API->object->str( path ) ) ) 
	{
	API->vm->throw_exception("Atmosphere", "Provided file does not contain the adequate number of channels, Atmosphere2 requires 9 channels.", nullptr);
	return;
	}
