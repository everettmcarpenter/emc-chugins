...
//         (e.g., `QUERY->begin_class(QUERY, "Atmosphere", "Object");`)
//      2. remove or commment out the line containing QUERY->add_ugen_func()
//      3. that's it; the rest is no different for UGens/non-UGens
//-----------------------------------------------------------------------------
// NOTE once you have built this into a chugin (Atmosphere.chug), here are a few
//      helpful tools for testing / probing / verifying your new chugin!
//
// chuginate also generated a Atmosphere-test.ck boilerplate ChucK program
//      to help test your chugin (see Atmosphere-test.ck for more instructions)
//
...
CK_DLL_MFUN( atmosphere1_setParam );
CK_DLL_MFUN( atmosphere1_getParam );
...
CK_DLL_QUERY( Atmosphere )
{
    ...
    QUERY->add_mfun( QUERY, atmosphere1_setParam, "float", "param" );
    // example of adding argument to the above method
    QUERY->add_arg( QUERY, "float", "arg" );

    // example of adding getter method
    QUERY->add_mfun( QUERY, atmosphere1_getParam, "float", "param" );
