...
//    (the bulid process should yield a TripleWaveshaper.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:TripleWaveshaper.chug TripleWaveshaper-test.ck`
//
...
//    `chuck --chugin:TripleWaveshaper.chug TripleWaveshaper-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a TripleWaveshaper
TripleWaveshaper obj;
