...
#include "../../emc-syntheaders/Swarm.h"
...
//-----------------------------------------------------------------------------
CK_DLL_QUERY( Granulator )
{
    // generally, don't change this...
    QUERY->setname( QUERY, "Granulator" );
    ...
    QUERY->begin_class( QUERY, "Granulator", "UGen" );

    // register default constructor
    QUERY->add_ctor( QUERY, granulator_ctor );
