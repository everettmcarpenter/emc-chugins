...
//    (the bulid process should yield a Granulator.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:Granulator.chug Granulator-test.ck`
//
...
//    `chuck --chugin:Granulator.chug Granulator-test.ck -v3`
//--------------------------------------------------------------------
