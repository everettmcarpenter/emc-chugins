...
//    (the bulid process should yield a Pulsar.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:Pulsar.chug Pulsar-test.ck`
//
...
//    `chuck --chugin:Pulsar.chug Pulsar-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a Pulsar
Pulsar obj;
